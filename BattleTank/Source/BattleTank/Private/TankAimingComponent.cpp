...
void UTankAimingComponent::AimAt(FVector OutHitLocation, float LaunchSpeed)
{
	...
	if(UGameplayStatics::SuggestProjectileVelocity(this, OutLaunchVelocity, StartLocation, OutHitLocation, LaunchSpeed, ESuggestProjVelocityTraceOption::TraceFullPath))
	{
